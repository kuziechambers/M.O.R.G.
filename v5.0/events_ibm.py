...
def play_response(text):
    sound_path = "/Users/kuziechambers/PycharmProjects/M.O.R.G./stt_files/temp_response.wav"
    ...
    fx_to_file()
    playsound("/Users/kuziechambers/PycharmProjects/M.O.R.G./stt_files/temp_response_fx.wav")
...
# STT FUNCTIONS
def stt_transcribe():
   if path.exists("/Users/kuziechambers/PycharmProjects/M.O.R.G./stt_files/spoken_input.wav"):
      with open('/Users/kuziechambers/PycharmProjects/M.O.R.G./stt_files/spoken_input.wav', 'rb') as audio_file:
      ...
      os.remove("/Users/kuziechambers/PycharmProjects/M.O.R.G./stt_files/spoken_input.wav")
      print(text_output)
...
def start_recording():
   ...
   write('/Users/kuziechambers/PycharmProjects/M.O.R.G./stt_files/spoken_input.wav', fs, recording)  # Save as WAV file
   if path.exists("/Users/kuziechambers/PycharmProjects/M.O.R.G./stt_files/spoken_input.wav"):
      send_text("Recording stopped, audio file saved./n/n-M.O.R.G.")
      print("Recording stopped, audio file saved.")
   if not path.exists("/Users/kuziechambers/PycharmProjects/M.O.R.G./stt_files/spoken_input.wav"):
