...
os.system("cd /home/pi; ./ngrok http -region=us -hostname=morg.ngrok.io -log=stdout 5000 > /Users/kuchambers/PycharmProjects/ngrok.log &")
    ...
    class Compute(Thread):
        ...
        def run(self):
            ...
            if self.target == "anything_else":
                ...
                flask_log.info(str(now_date) + " | " + str(now_time) + "-----FLASK----------: " + str(self.request.values.get('Body', None)))
                time.sleep(5)
                anythingelse_phrases = ["/Users/kuchambers/PycharmProjects/M.O.R.G./stt_files/anythingelse.wav",
                                        "/Users/kuchambers/PycharmProjects/M.O.R.G./stt_files/isthatall.wav",
                                        "/Users/kuchambers/PycharmProjects/M.O.R.G./stt_files/willthatbeall.wav"]
