...
while True:
    try:
        ...
        if switch == "outside":
            ...
            if 115200 < (nowtime - lastMotion).total_seconds() < 115207 and 3 <= weekday <= 6 and afternoonstart <= nowtime <= afternoonend:
                try:
                    server = smtplib.SMTP( "smtp.gmail.com", 587 )
                    server.starttls()
                    server.login('kuzie.chambers@gmail.com','Kc24962387103!' )
            ...
            if 36000 < (nowtime- lastMotion).total_seconds() < 36007 and morningstart <= nowtime <= morningend:
                try:
                    server = smtplib.SMTP( "smtp.gmail.com", 587 )
                    server.starttls()
                    server.login('kuzie.chambers@gmail.com','Kc24962387103!' )
            ...
            if 25200 < (nowtime - lastMotion).total_seconds() < 25207 and eveningstart <= nowtime <= eveningend:
                try:
                    server = smtplib.SMTP( "smtp.gmail.com", 587 )
                    server.starttls()
                    server.login('kuzie.chambers@gmail.com','Kc24962387103!' )
