            ...
            if switch == "outside":
                ...
                if ready is True:
                    ...
                    if morningstart <= nowtime <= morningend:
                        ...
                        if (now - lastMotion).total_seconds() > 1500 and (now - lastMotion).total_seconds() < 4800: # PLAY WELCOME BACK
                        ...
                        if (now - lastMotion).total_seconds() > 4800 and (now - lastMotion).total_seconds() < 8400: #PLAY REGULAR EVENING
                            lastMotion = now
